...
const products = [
    {
        ...
        photos: ["NEWEMO/emogreatagain/1 фото.png", "NEWEMO/emogreatagain/фото 2.png","NEWEMO/emogreatagain/серега 1.png", "NEWEMO/emogreatagain/фото 3.png", "NEWEMO/emogreatagain/размерная сеткаа.png"],
    ...
    photos: ["NEWEMO/f/1 фото.png", "NEWEMO/f/серега фото.png", "NEWEMO/f/DSC_8123.JPG", "NEWEMO/f/3 фото.png", "NEWEMO/emogreatagain/размерная сеткаа.png"],
...
},
    {
        ...
        photos: ["NEWEMO/LV/1 фото.png", "NEWEMO/LV/серега 1.png", "NEWEMO/LV/DSC_8101.JPG","NEWEMO/LV/DSC_8107.JPG","NEWEMO/LV/серега 2.png","NEWEMO/LV/размерная сеткаа.png"],
        size: "S/M/L/XL/2XL",
    ...
    },
    {
        ...
        photos: ["NEWEMO/Е.Г.Э/фото 1.png","NEWEMO/Е.Г.Э/DSC_8011.JPG", "NEWEMO/Е.Г.Э/DSC_8566.png", "NEWEMO/Е.Г.Э/DSC_8039.JPG","NEWEMO/Е.Г.Э/DSC_8043.JPG", "NEWEMO/Е.Г.Э/размерная сетка (для маяк).png"],
    ...
    },
    {
        ...
        photos: ["NEWEMO/kick-ass/1 фото.png", "NEWEMO/kick-ass/2 фото.png", "NEWEMO/kick-ass/DSC_8549.png", "NEWEMO/kick-ass/DSC_8165.JPG","NEWEMO/kick-ass/DSC_8535.png", "NEWEMO/kick-ass/DSC_8149.JPG", "NEWEMO/kick-ass/размерная сетка (для маяк).png"],
        modelImage: "NEWEMO/kick-ass/DSC_8549.png",
        size: "S/M/L/XL/2XL",
        desc: "95% хлопок, 5% лайкра. Покрой: прямой. Печать: DTG. Индивидуальная нумерация: на бирке каждого изделия будет свой номер (акция продлится до 31 августа, после чего нумерация больше не будет). Маша - 170/60, на ней M. Серёга  - 180/65, на нём M. Отправка от 3–7 дней.",
        stock: { S: 10, M: 5, L: 3, XL: 2, "2XL": 0 },
        emo: true
    },
    {
        ...
        photos: ["NEWEMO/Please love me/1 фото.png", "NEWEMO/Please love me/22 фото.png", "NEWEMO/Please love me/DSC_8593.png", "NEWEMO/Please love me/DSC_8369.JPG","NEWEMO/Please love me/размерная сетка (для маяк).png"],
        modelImage: "NEWEMO/Please love me/DSC_8593.png",
        size: "S/M/L/XL/2XL",
...
// Делаем products доступным глобально для checkout.js и product.js
window.products = products;
window._slengSetProducts = function (data) {
    products = data;
...
// ==================== СКРЫТЫЙ ПЕРЕХОД В АДМИНКУ (рядом с «О нас» в футере) ====================
function injectAdminGate() {
    if (document.getElementById("slengAdminGate")) return;
    const aboutBtn = document.querySelector('.footer-btn[data-footer="about"]');
    if (!aboutBtn) return;

    const col = aboutBtn.closest(".footer-col");
    if (!col) return;

    col.classList.add("footer-about-col");
